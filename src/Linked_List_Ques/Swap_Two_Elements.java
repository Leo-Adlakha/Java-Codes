...
/*SWAP TWO ELEMENTS( DATA, DATA)
Implement code to swap two elements of a Linked List.


Input Format:
Enter number of elements N, and N space separated elements. Enter the numbers to be swapped.
...
public class Swap_Two_Elements {
	...
	public static void main(String[] args) throws Exception {
		...
		Swap_Two_Elements m = new Swap_Two_Elements() ;
